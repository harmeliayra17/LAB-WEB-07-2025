...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-blue-600 mb-6">Tambah Gudang</h1>
        @if ($errors->any())
        ...
        <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6">
            <form action="{{ route('warehouses.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="location" id="location" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 transition duration-200 p-2 h-24 resize-y"></textarea>
                </div>
