...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-blue-600 mb-6">Tambah Stok Gudang</h1>
        @if ($errors->any())
        ...
        <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6">
            <form action="{{ route('product-warehouse.store') }}" method="POST" class="space-y-6">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <select name="warehouse_id" id="warehouse_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 transition duration-200 p-2" required>
                ...
                <div>
                    ...
                    <input type="number" name="quantity" id="quantity" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 transition duration-200 p-2" required min="0">
                </div>
