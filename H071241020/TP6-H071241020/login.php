    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form method="POST" action="login_process.php" class="space-y-4">
            <div>
                ...
                <input type="text" id="username" name="username" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
        ...
        <?php if (isset($_GET['error'])) echo '<p class="text-red-500 text-center mt-2">Invalid credentials!</p>'; ?>
    </div>
</body>
</html>